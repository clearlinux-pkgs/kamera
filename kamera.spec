...
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/kamera-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/kamera-23.04.2.tar.xz.sig
...
%prep
%setup -q -n kamera-23.04.2
cd %{_builddir}/kamera-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686520072
mkdir -p clr-build
pushd clr-build
