...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kamera-21.12.0.tar.xz
...
%prep
%setup -q -n kamera-21.12.0
cd %{_builddir}/kamera-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639626325
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kamera-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/kamera/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/kamera-21.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kamera/0c4be15f5177aafffe980ca09c0f4ca6ed741f43
pushd clr-build
%make_install
popd
%find_lang kcmkamera
