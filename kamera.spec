...
Version  : 24.12.3
Release  : 79
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kamera-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kamera-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kamera-24.12.3.tar.xz.sig
...
%setup -q -n kamera-24.12.3
cd %{_builddir}/kamera-24.12.3
pushd ..
cp -a kamera-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742464142
mkdir -p clr-build
pushd clr-build
