...
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/kamera-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/kamera-23.08.1.tar.xz.sig
...
%prep
%setup -q -n kamera-23.08.1
cd %{_builddir}/kamera-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695081603
mkdir -p clr-build
pushd clr-build
