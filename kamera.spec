...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kamera-22.08.0.tar.xz
...
%prep
%setup -q -n kamera-22.08.0
cd %{_builddir}/kamera-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661546780
mkdir -p clr-build
pushd clr-build
