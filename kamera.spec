...
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/kamera-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/kamera-20.08.2.tar.xz.sig
...
%prep
%setup -q -n kamera-20.08.2
cd %{_builddir}/kamera-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602633364
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kamera-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/kamera/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/kamera-20.08.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kamera/0c4be15f5177aafffe980ca09c0f4ca6ed741f43
pushd clr-build
%make_install
popd
%find_lang kcmkamera
