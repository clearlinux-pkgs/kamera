...
Version  : 24.08.2
Release  : 74
URL      : https://download.kde.org/stable/release-service/24.08.2/src/kamera-24.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/kamera-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/kamera-24.08.2.tar.xz.sig
...
%setup -q -n kamera-24.08.2
cd %{_builddir}/kamera-24.08.2
pushd ..
cp -a kamera-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728603432
mkdir -p clr-build
pushd clr-build
