...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kamera-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kamera-24.12.2.tar.xz.sig
...
%setup -q -n kamera-24.12.2
cd %{_builddir}/kamera-24.12.2
pushd ..
cp -a kamera-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738970992
mkdir -p clr-build
pushd clr-build
